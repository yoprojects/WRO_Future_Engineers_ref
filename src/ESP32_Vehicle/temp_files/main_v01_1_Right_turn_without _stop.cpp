...
void turnRight90Degrees() {
  ...
  while (millis() - turnStartTime < MAX_TURN_TIME && abs(angleChanged) < 117) {
    mpu6050.update();
...
void loop() {
  ...
  else if (distFront < 75) {
    // If front obstacle detected (<75cm), turn right 90 degrees - PRIORITY OVER RIGHT OPENING
