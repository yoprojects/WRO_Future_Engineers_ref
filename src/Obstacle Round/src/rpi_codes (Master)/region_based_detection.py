...
def calculate_steering(blocks, color):
    ...
    # Check if block is at extreme edge where going straight is sufficient
...
def draw_debug(frame, red_blocks, green_blocks, steering, state):
    ...
    if in_turn_mode:
        cv2.putText(debug_frame, f"{turn_type}: {turn_phase}", (10, FRAME_H - 90), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 0), 2)
    ...
    # System info
    cv2.putText(debug_frame, f"Queue: {queue_size}", (10, FRAME_H - 60), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255, 255, 0), 2)
    cv2.putText(debug_frame, f"Data: {data_age:.2f}s", (10, FRAME_H - 30), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255, 255, 0), 2)
